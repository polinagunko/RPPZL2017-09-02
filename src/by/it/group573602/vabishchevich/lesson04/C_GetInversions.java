...
public class C_GetInversions {
    int count = 0;
    private int[] merge_Sort(int[] massive)
    {
        if (massive.length == 1)
            return massive;
    ...
    int calc(InputStream stream) throws FileNotFoundException {
        ...
        int[] a = new int[n];
        for (int i = 0; i < n; i++) {
            System.out.println(a[i] = scanner.nextInt());
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group573602/vabishchevich/lesson04/dataC.txt");
