...
public class C_GetInversions {
    ...
    private int[] sort(int[] array1, int[] array2) {
        int x = 0, y = 0;
    ...
    private int[] M_sort(int[] mass){
        if(mass.length==1)
            ...
            System.arraycopy(mass,0,Left,0,middle);
            System.arraycopy(mass,middle,Right,0,length-middle);
            Left=M_sort(Left);
            Right=M_sort(Right);
