...
public class C_GreedyKnapsack {
    ...
    double calc(File source) throws FileNotFoundException {
        ...
        int i=0;
        while(weight<W){
            if((double)items[i].weight>(double)W-weight) {
                result = result + ((double) W - weight) / (double) items[i].weight* (double) items[i].cost;
                weight=weight+(double) items[i].weight;
            }
            else {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f=new File(root+"by/it/group573602/gurskiy/lesson02/greedyKnapsack.txt");
