package by.it.group573602.gurskiy2.lesson10;

/**
 * Created by Roman on 22.12.2017.
 */
import by.it.group573602.gurskiy2.lesson10.DirectedGraph;
        ...
        for (int i = 0; i < graph.letters.size();i++){
            if (graph.istoks_stok.get(graph.letters.get(i))[0] == 0 )
                ...
                if (graph.istoks_stok.get(graph.letters.get(i))[1] == 0) {
                    System.out.println(graph.letters.get(i) + " - Cток");
                }
