package by.it.group573602.kondrashevich.lesson10;
...
public class GraphC {
    ...
    // our graph
    static by.it.group573602.kondrashevich.lesson10.DirectedGraph graph;
    // map of visited vertices
    static Map<String, by.it.group573602.kondrashevich.lesson10.GraphC.Mark> visitedMap = new LinkedHashMap<String, by.it.group573602.kondrashevich.lesson10.GraphC.Mark>();
    // time counter
    static int counter = 1;

    public static void main(String[] args) {

        graph = new by.it.group573602.kondrashevich.lesson10.DirectedGraph();
        graph.addEdge("A", "C");
        graph.addEdge("B", "C");
        graph.addEdge("C", "D");
        graph.addEdge("C", "E");
        ...
        for (Map.Entry<String, by.it.group573602.kondrashevich.lesson10.GraphC.Mark> entry : visitedMap.entrySet()) {
            by.it.group573602.kondrashevich.lesson10.GraphC.Mark m = entry.getValue();
...
// set pre (time of enter)
        visitedMap.put(vertexName, new by.it.group573602.kondrashevich.lesson10.GraphC.Mark(counter, -1));
        counter++;
...
// set post (time of exit)
        by.it.group573602.kondrashevich.lesson10.GraphC.Mark m = visitedMap.get(vertexName);
        m.post = counter++;
    }
}