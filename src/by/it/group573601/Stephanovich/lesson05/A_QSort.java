package by.it.group573601.Stephanovich.lesson05;
...
public class A_QSort {
    ...
    private class Point implements Comparable<Point>{
        //Интерфейс Comparable он типизуется текущим классом
        int p;
        int i;
        ...
        если возращает отриц. ч.то текущий объект распологается перт тем
        который передается параметр
        Если полож. ч. то наоборот. после 2-ого объекта
        Если ноль значит равны
        */
