package by.it.group573601.krautsou.lesson02;
...
public class A_VideoRegistrator {
    ...
    List<Double> calcStartTimes(double[] events, double workDuration) {
        ...
        while (i < events.length - 1) {             //пока есть незарегистрированные события
            ...
            time = events[i] + workDuration;        //и запомним время старта видеокамеры
            while (events[i] < time)                //вычислим момент окончания работы видеокамеры
