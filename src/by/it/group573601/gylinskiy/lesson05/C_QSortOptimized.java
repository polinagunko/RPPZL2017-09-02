package by.it.group573601.gylinskiy.lesson05;
...
public class C_QSortOptimized
{
    ...
    public static Segment[] qSort(Segment n[], int left, int right)
    {
        ...
        while (l <= r)
        {
            while (n[l].compareTo(x) < 0) { l++; }
            while (n[r].compareTo(x) > 0) { r--; }
            if (l <= r)
            {
                Segment t = n[l];
                n[l] = n[r];
        ...
        if (left < r) { qSort(n, left, r); }
        if (l < right) { qSort(n, l, right); }
        return n;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group573601/gylinskiy//lesson05/dataC.txt");
