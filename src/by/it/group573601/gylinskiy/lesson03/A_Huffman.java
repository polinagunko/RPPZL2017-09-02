package by.it.group573601.gylinskiy.lesson03;
...
public class A_Huffman
{
    ...
    String encode(File file) throws FileNotFoundException
    {
       ...
       for(Map.Entry<Character, Integer> entry: count.entrySet()) {
        ...
        {
            Node internalNode = new InternalNode(priorityQueue.poll(), priorityQueue.poll());
        ...
        priorityQueue.poll().fillCodes(st);
        for(int i=0;i<s.length();i++)
        {
            sb.append(codes.get(s.charAt(i)));
        }
        System.out.println("Получаем : " + sb.toString());
        return sb.toString();
        //01001100100111
        //01001100100111
    }
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        File f = new File(root + "by/it/group573601/gylinskiy/lesson03/dataHuffman.txt");
