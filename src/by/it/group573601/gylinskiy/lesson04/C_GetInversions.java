...
public class C_GetInversions
{
    ...
    private static void setInversions()
    {
        C_GetInversions.inversions ++;
    }
    ...
    private static int[] divideWithInversions(int[] source)
    {
        ...
        return mergeWithInversions(divideWithInversions(Arrays.copyOfRange(source, 0, middle)), divideWithInversions(Arrays.copyOfRange(source, middle, len)));
    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group573601/gylinskiy/lesson04/dataC.txt");
