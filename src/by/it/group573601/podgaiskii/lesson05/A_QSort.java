...
public class A_QSort {
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
        ...
        Segment[] segments = new Segment[segmentNumber];
        //число точек
        int pointNumber = scanner.nextInt();
        int[] points = new int[pointNumber];
        int[] result = new int[pointNumber];
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group573601/podgaiskii/lesson05/dataA.txt");
