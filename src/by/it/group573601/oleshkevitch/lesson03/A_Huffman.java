...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> entry : count.entrySet()) {//создаем представление Map в виде пары ключ-значение
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/group573601/oleshkevitch/lesson03/dataHuffman.txt");
