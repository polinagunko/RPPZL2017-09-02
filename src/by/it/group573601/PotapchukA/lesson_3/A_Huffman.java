package by.it.group573601.PotapchukA.lesson_3;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for(int i=0;i<s.length();i++)
            if(count.putIfAbsent(s.charAt(i),1)!=null)
        ...
        while (true){
            nodeOne=priorityQueue.poll();
            nodeTwo=priorityQueue.poll();
            priorityQueue.add(new InternalNode(nodeOne,nodeTwo));
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/group573601/PotapchukA/lesson_3/dataHuffman.txt");
