package by.it.group573601.PotapchukA.lesson_5;
...
public class C_QSortOptimized {
    ...
    private int[] division3(Segment[] a, int low, int high){
    ...
    private void quickSort3(Segment[] a, int low, int high){
        while(low < high){
            int[] middle = division3(a, low, high);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group573601/PotapchukA/lesson_5/dataC.txt");
